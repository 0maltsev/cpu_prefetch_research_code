...
- Supersedes: None
- Lifecycle gate: Accepted by Q6 before Stage 7 implementation
...
The repository owner accepted Q6 exactly as proposed on 2026-08-17. Stage 7
implementation may rely on this decision, subject to all verification gates
below; acceptance does not authorize an experiment.
...
The decision adds purpose label `arrival-schedule`, consumes one 64-bit draw per
...
Scientific effect: the decision prospectively fixes a midpoint approximation
...
Any bit-, deadline-, or identity-changing revision needs a new suite ID,
superseding ADR, prospective artifact regeneration, and full Stage 7
...
a normative scientific requirement, stop the affected work and require a
versioned protocol amendment plus a superseding ADR rather than implementing
the conflict.
