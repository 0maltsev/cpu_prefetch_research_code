...
Protocol version: **`2.0.0-pre.3`**. Primary data and lifecycle instances are
incompatible with `1.x`; pre.3 run and freeze records add the D-116 warm-up
regime and source-lineage boundary that pre.2 cannot represent. Prior
snapshots remain readable and immutable; see `AMENDMENTS.md`.
