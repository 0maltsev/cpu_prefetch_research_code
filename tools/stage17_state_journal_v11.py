#!/usr/bin/env python3
"""Stage 17 external-journal runtime bound to semantic policy v13.
...
import stage17_semantic_verifier_v13 as semantic
import stage17_state_journal as base
import stage17_state_journal_v10 as predecessor
