...
def author_ext001(
    *, repository_root: pathlib.Path, evidence_root: pathlib.Path,
    ...
    contract = {
        ...
        "contract_id": contract_id, "protocol_version": "2.0.0-pre.2",
    ...
    contract_path = destination / "supporting-contract-v8.json"
    ...
    authorization_path = destination / "authorization-v8.json"
    write_external_exclusive(authorization_path, canonical(authorization))
    envelope = {
        "schema_version": "cpu-prefetch-stage17-operational-evidence-envelope/9",
        ...
        "authorization": _repository_binding(
            ...
            schema_identity="cpu-prefetch-stage17-read-only-preflight-authorization/8",
        ),
    ...
    envelope_path = destination / "envelope-v9.json"
    validate_schema(
        repository_root,
