...
import stage17_read_only_preflight_semantic_verifier_v15 as current_semantic
import stage17_state_journal
import stage17_state_journal_v10
import stage17_state_journal_v11
import stage17_state_journal_v20 as current_journal


EXECUTOR_ID = "STAGE17-READ-ONLY-PREFLIGHT-EXECUTOR-v14"
...
def _prospective_validation(
    *, repository_root: pathlib.Path, latest_journal: pathlib.Path,
    ...
    if (
        ...
        action_context = current_semantic.evaluate_s17_ext_001_action_readiness_v15(
