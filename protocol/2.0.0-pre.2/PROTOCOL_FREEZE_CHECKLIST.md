...
| Manifest/schema versions | Draft 2020-12 schema IDs, compatibility matrix, positive/negative conformance suite, semantic-validator contract | **FIXED STRUCTURE:** handoff schemas at `2.0.0-pre.2` | implementation must reject mixed graphs and unknown versions; conversion creates a new derived artifact |
