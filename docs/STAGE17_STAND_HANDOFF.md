...
test -f "$S17_REPOSITORY/docs/decisions/0104-stage17-pilot-operational-governance-successor.md"
test -f "$S17_REPOSITORY/config/q15/q15-r-p4-r-i-d099-authorization-v1.json"
test ! -e "$S17_EVIDENCE"
