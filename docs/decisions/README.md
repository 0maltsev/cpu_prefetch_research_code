...
| [ADR-0115](0115-stage17-production-pilot-and-handoff-boundary.md) | `ACCEPTED_IMPLEMENTED_REPOSITORY_LOCAL_NO_AUTHORITY` | Bind full clean-bundle/EXT006 provenance, supervised Q15, complete Q16/pilot semantics, streamed typed outputs, canonical handoff, exact Stage 17 exit, and independent Phase 18 preparation. |
