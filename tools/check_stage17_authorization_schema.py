...
def main() -> int:
    ...
    semantic_admission_schema_paths = (
        ...
        "stage17-operational-evidence-admission-policy-v16.schema.json",
        "stage17-operational-evidence-admission-policy-v17.schema.json",
        "stage17-operational-evidence-envelope-v12.schema.json",
        "stage17-read-only-preflight-evidence-admission-policy-v12.schema.json",
        "stage17-read-only-preflight-evidence-admission-policy-v13.schema.json",
        "stage17-read-only-preflight-authorization-v10.schema.json",
        "stage17-read-only-preflight-supporting-contract-v10.schema.json",
        "stage17-read-only-preflight-attempt-v8.schema.json",
        "stage17-read-only-preflight-attempt-v9.schema.json",
        "stage17-preflight-pre-marker-blocker-v1.schema.json",
        "stage17-preflight-post-marker-blocker-v1.schema.json",
        ...
        "stage17-read-only-preflight-authorization-v11.schema.json",
        "stage17-read-only-preflight-supporting-contract-v11.schema.json",
        "stage17-operational-evidence-envelope-v13.schema.json",
        "stage17-read-only-preflight-fixed-action-plan-v8.schema.json",
        "stage17-operational-evidence-admission-policy-v18.schema.json",
        "stage17-operational-evidence-envelope-v14.schema.json",
        "stage17-read-only-preflight-supporting-contract-v12.schema.json",
        "stage17-read-only-preflight-evidence-admission-policy-v14.schema.json",
        "stage17-read-only-preflight-fixed-action-plan-v9.schema.json",
        "stage17-read-only-preflight-attempt-v10.schema.json",
        "stage17-read-only-preflight-observation-receipt-v7.schema.json",
        "stage17-read-only-preflight-failure-v8.schema.json",
        "stage17-read-only-preflight-failure-retention-v3.schema.json",
        "stage17-read-only-preflight-completion-v7.schema.json",
        "stage17-preflight-action-revalidation-blocker-v1.schema.json",
