...
def author_ext001(
    *, repository_root: pathlib.Path, evidence_root: pathlib.Path,
    ...
    action_revalidation_blocker: pathlib.Path,
    ...
    contract_path = destination / "supporting-contract-v12.json"
    ...
    envelope = {
        ...
        "predecessor": {
            ...
            "semantic_policy_v13_sha256":
                policy["predecessor"]["policy_v13"]["sha256"],
    ...
    try:
        ...
        if arguments.command == "init":
            ...
            result = author_ext001(
                ...
                action_revalidation_blocker=arguments.action_revalidation_blocker.resolve(),
