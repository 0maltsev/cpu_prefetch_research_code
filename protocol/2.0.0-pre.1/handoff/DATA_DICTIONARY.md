...
| Estimability | `NOT_EVALUATED`, `ESTIMABLE`, `BLOCKED_ZERO_LOSS`, `BLOCKED_EFFECTIVE_TAIL`, `BLOCKED_INVALID_RUN`, `BLOCKED_INCOMPLETE_BLOCK`, `BLOCKED_ACCESS_LEAKAGE`, `NOT_APPLICABLE` |
