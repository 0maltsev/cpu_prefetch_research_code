...
| P4-R-C prerequisite decisions | `D100_D103_PROPOSED_EXACT_ACCEPTANCE_REQUIRED_NO_ACTION_AUTHORITY` | Machine record SHA-256 `faa4c377...` identifies four unresolved security/compatibility choices: single-owner review, exact D-099 custody-root compatibility, fixed OpenSSH remote-command boundary, and namespace-parent creation. Twelve negative mutations pass; all selections/prerequisites and action authority remain null/false. |
