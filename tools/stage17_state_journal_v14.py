#!/usr/bin/env python3
"""Stage 17 journal runtime bound to semantic policy v16."""
...
import stage17_semantic_verifier_v16 as semantic
import stage17_state_journal_v13 as predecessor
...
def checked_in_status(root: pathlib.Path) -> OperationalJournalValidation:
    ...
    return validate_operational_journal(repository_root=root.resolve(),
        evidence_root=root.resolve(), latest_journal=latest,
