...
Protocol version: **`2.0.0-pre.2`**. This version adds the exhaustive simultaneous-blocker manifest representation authorized by Q10/Q11. It preserves the observation model and scientific gates; lineage and prior hashes are preserved in `handoff/PROTOCOL_VERSION.md` and `handoff/AMENDMENTS.md`.
