...
Protocol version: **`2.0.0-pre.1`**. A decision remains open unless repository evidence fixes it. Confirmatory treatment outcomes may not be used to settle any open item. Version `2.0.0-pre.1` changes the primary logical data model incompatibly; it does not freeze a physical raw format.
