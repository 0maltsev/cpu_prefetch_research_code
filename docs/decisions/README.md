...
| [ADR-0114](0114-stage17-fixed-action-production-boundary.md) | `ACCEPTED_IMPLEMENTED_REPOSITORY_LOCAL_NO_AUTHORITY` | Replace policy-v9 production claims with independent EXT002/003 trust, EXT003/006 release binding, six compiled fd-only actions, exact-byte worker/request snapshots, typed output verification, and separate signed Phase 18 access. |
