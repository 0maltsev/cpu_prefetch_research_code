#!/usr/bin/env python3
"""Stage 17 canonical-serializer runtime bound to semantic policy v14.
...
import stage17_semantic_verifier_v14 as semantic
import stage17_state_journal as base
import stage17_state_journal_v11 as predecessor
