...
- Version: **`2.0.0-pre.3`**
- Status: D-116 pilot warm-up bootstrap amendment
- Date: 2026-08-28
...
- Compatibility: new sealed artifact graphs consistently use
  `2.0.0-pre.3`. Prior instances remain immutable and readable only under
  their original version or through an explicit provenance-bearing derived
  conversion. A pre.2 run manifest cannot represent the new warm-up regime
  and freeze identity.
...
The move from `2.0.0-pre.2` to `2.0.0-pre.3` is a prerelease scientific
amendment. It resolves the first-pilot circular dependency by assigning the
existing five-second floor only to explicitly marked non-confirmatory
pre-freeze calibration/pilot runs, then freezes later warm-up from complete
valid pilot evidence using exact run-level extrema and upward tick rounding.
No estimand, factor, queue, contrast, outcome, replacement, or access rule
changes.
...
| `2.0.0-pre.2` | 2026-08-21 | superseded for new warm-up records; immutable and readable | `handoff/AMENDMENTS.md`, amendment `AMEND-2.0.0-pre.2-D031-MULTI-BLOCKER` |
| `2.0.0-pre.3` | 2026-08-28 | current | `handoff/AMENDMENTS.md`, amendment `AMEND-2.0.0-pre.3-D116-PILOT-WARMUP-BOOTSTRAP` |
...
## Preserved `2.0.0-pre.2` authoritative hashes
...
The final `2.0.0-pre.3` hashes are recorded after document synchronization,
schema conformance, and import-manifest verification. The unchanged paper PDF
retains its earlier content hash; the append-only amendment records the new
pre-execution semantics.

| Artifact | SHA-256 |
|---|---|
| `paper/main.pdf` | `f7dccf3db2a4809c8d703d294f1407f91322cbc918cb2083b689c1c755b8d60e` |
| `EXPERIMENT_IMPLEMENTATION_SPEC.md` | `a32a518d146d76ce81165db049c72d4bf7367841b1b6d59e1ad031888a816cb7` |
| `PROTOCOL_FREEZE_CHECKLIST.md` | `d95eed8b40dbefa79fae68dbfd160359599fd48370a3276be58b1b7f92a57bac` |
| `AGENTS.md` | `0a5016b8ab29e68ae1ec14bac1f3812251f05e8ee4629481a9e933374e6aabf7` |
