#!/usr/bin/env python3
"""Fail-closed Stage 17 operational CLI with canonical-serializer preflight successor.
...
import stage17_state_journal_v12 as journal_runtime
...
def author_ext001(
    *, repository_root: pathlib.Path, evidence_root: pathlib.Path,
    ...
    envelope = {
        "schema_version": "cpu-prefetch-stage17-operational-evidence-envelope/11",
        ...
        "predecessor": {
            ...
            "semantic_policy_v10_sha256":
                policy["predecessor"]["policy_v10"]["sha256"],
    ...
    envelope_path = destination / "envelope-v11.json"
    validate_schema(
        repository_root,
